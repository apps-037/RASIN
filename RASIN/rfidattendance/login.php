...
<main>
  <h1 class="slideInDown animated" style="color:white">Login with the Admin E-mail and Password</h1>
    ...
    <div class="login-page">
      <div class="form">
        ...
        <form class="reset-form" action="reset_pass.php" method="post" enctype="multipart/form-data">
          ...
          <p class="message"style="background-color:#381470"><a href="#">LogIn</a></p>
        </form>
        <form class="login-form" action="ac_login.php" method="post" enctype="multipart/form-data">
          <input type="email" name="email" id="email" placeholder="E-mail..." required/>
          <input type="password" name="pwd" id="pwd" placeholder="Password" required/>
          <button type="submit" name="login" id="login"style="background-color:#381470">login</button>
