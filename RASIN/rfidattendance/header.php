...
<style>
body{
    background: -webkit-linear-gradient(left,#1e0e25, #21a0ab);
...
<header>
<div class="header" style=" background: -webkit-linear-gradient(left,#1e0e25, #a975e6);
   ">
	<div class="logo">
		<a href="index.php" >RASIN</a>
	</div>
</div>
<?php  
  if (isset($_GET['error'])) {
...
?>
<div class="topnav" id="myTopnav" style="background-color: #250359">
