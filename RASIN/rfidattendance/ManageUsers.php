...
<main>
	...
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				<legend><span class="number" style="background-color:#381470">1</span> User Info</legend>
			...
			<fieldset>
			<legend><span class="number" style="background-color:#381470">2</span> Additional Info</legend>
			<label>
			...
			<button type="button" name="user_add" class="user_add" style="background-color:#381470">Add User</button>
			<button type="button" name="user_upd" class="user_upd"style="background-color:#381470">Update User</button>
			<button type="button" name="user_rmo" class="user_rmo"style="background-color:#381470">Remove User</button>
		</form>
	</div>
