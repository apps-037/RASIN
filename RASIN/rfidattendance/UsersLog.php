...
<body style=" background: -webkit-linear-gradient(left,#1e0e25, #a975e6);
   ">
   <style>.modal-header, .modal-footer {
...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated"style="color:white">Here are the Users daily logs</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export"style="background-color:#381470">Log Filter/ Export to Excel</button>
    </div>
    <!-- Log filter -->
    <div class="modal fade bd-example-modal-lg" id="Filter-export" tabindex="-1" role="dialog" aria-labelledby="Filter/Export" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header"style="background-color:#381470">
          ...
          <form method="POST" action="Export_Excel.php" enctype="multipart/form-data">
            ...
            <div class="modal-footer" style="background-color:#381470">
